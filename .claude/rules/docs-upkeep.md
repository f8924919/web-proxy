...
- **index 追記**: ファイルを追加・改名・削除したら、同フォルダの `index.md` を必ず更新する（spec / arch / task それぞれ。docs-guide §3.4）。
...
- **完了タスクの archive 移動**: docs-guide §4.2 の手順に従う。`main` への直コミットは禁止のため、docs ブランチ＋PR で行う。
